...
class TrainingLogApp:
    ...
    def create_widgets(self):
        # Создает виджеты для ввода данных о тренировке.
    ...
    def view_records(self):
        # загружает сохраненные данные и отображает их в новом окне.
        data = load_data()
    ...
    def export_all_records_csv(self):
        ...
        data = load_data()
        with open('workout_log.csv', 'w', newline='') as file:
    ...
    def import_records_csv(self):
        ...
        with open('workout_log.csv', 'r', newline='') as file:
